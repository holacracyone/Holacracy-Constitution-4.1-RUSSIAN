...
Если разные интерпретации противоречат друг другу, то приоритет отдается интерпретации, данной Секретарем, а все Партнеры обязаны следовать данной интерпретации до тех пор, пока не будут приняты изменения в той части Законодательства, что была интрепретирована.
